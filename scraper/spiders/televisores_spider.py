...
class TelevisoresSpider(scrapy.Spider):
    name = 'televisores'
    allowed_domains = ['mercadolibre.com.mx', 'listado.mercadolibre.com.mx']
    start_urls = ['https://listado.mercadolibre.com.mx/televisores']
    custom_settings = {
        'FEED_URI': 'data/raw/televisores.csv',
    }
